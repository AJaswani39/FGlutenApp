...
class ProfileFragment : Fragment() {
     ...
     */
    private fun displayUserProfile(userProfile: io.fgluten.data.user.UserProfile) {
        binding.apply {
            // Basic profile info
...
sealed class ProfileUiState {
    ...
    data class Success(val userProfile: io.fgluten.data.user.UserProfile) : ProfileUiState()
